...
const Contact = () => {
  ...
  // Format time to Philippine timezone
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_rpo4old', // Service ID
        'template_ksp7jqp', // Template ID
        {
          name: form.name,
          email: form.email,
          message: form.message,
          time: getPhilippineTime(), // Pass formatted PH time
        },
        'hoELitwT4yshh0roR' // Public Key
      )
      .then(
        () => {
          setLoading(false);
